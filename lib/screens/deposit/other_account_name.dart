...
class OtherAccountName extends StatefulWidget {
  ...
  @override
  State<OtherAccountName> createState() => _OtherAccountNameState();
}

class _OtherAccountNameState extends State<OtherAccountName> {
